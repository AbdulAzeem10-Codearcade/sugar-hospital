...
const labTests = [
  ...
  { sno: 2, name: 'SGPT', fee: 350 },
  { sno: 3, name: 'BLOOD GROUP', fee: 200 },
  { sno: 4, name: 'ESR', fee: 200 },
  { sno: 5, name: 'BILIRUBIN', fee: 350 },
  { sno: 6, name: 'CREATININE', fee: 350 },
  { sno: 7, name: 'CHOLESTEROL', fee: 400 },
  { sno: 8, name: 'CBC', fee: 500 },
  { sno: 9, name: 'HbA1C', fee: 1200 },
  { sno: 10, name: 'HBS (ICT)', fee: 250 },
  { sno: 11, name: 'HCV (ICT)', fee: 250 },
  { sno: 12, name: 'HIV (ICT)', fee: 300 },
  { sno: 13, name: 'Peripheral Smear', fee: 800 },
  { sno: 14, name: 'BLOOD H. Pylori', fee: 500 },
  { sno: 15, name: 'OGTT', fee: 700 },
  { sno: 16, name: 'M ALBUMIN', fee: 700 },
  { sno: 17, name: 'OMP', fee: 200 },
  { sno: 18, name: 'SUGAR (FBS/RBS)', fee: 150 },
  { sno: 19, name: 'TG', fee: 450 },
  { sno: 20, name: 'U ACID', fee: 350 },
  { sno: 21, name: 'URINE R/E', fee: 200 },
  { sno: 22, name: 'LIPID PROFILE', fee: 1400 },
  { sno: 23, name: 'UREA', fee: 350 },
  { sno: 24, name: 'Stool H. Pylori', fee: 500 },
  { sno: 25, name: 'S. Amylase', fee: 600 },
  { sno: 26, name: 'Pregnancy Test (ICT)', fee: 250 },
  { sno: 27, name: 'PT/INR', fee: 550 },
  { sno: 28, name: 'a PTT', fee: 400 },
  { sno: 29, name: 'CT/BT', fee: 450 },
  { sno: 30, name: 'Diabetic Health Profile - I', fee: 4000 },
  { sno: 31, name: 'Diabetic Health Profile - II', fee: 2500 },
  { sno: 32, name: 'Hypertension Screening Panel', fee: 3000 },
  { sno: 33, name: 'Basic Health Screen', fee: 2700 },
  { sno: 34, name: 'Viral Screening Panel', fee: 700 },
  { sno: 35, name: 'General Health Screen', fee: 5000 },
  { sno: 36, name: 'Dengue Ns', fee: 1500 },
  { sno: 37, name: 'ICT Malaria', fee: 400 },
]
